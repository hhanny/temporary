...
class SupplierSearch extends Supplier
{
    ...
    {
        return [
            [['supplier_id', 'hospital_id', 'created_by', 'updated_by', 'deleted_by'], 'integer'],
            [['name', 'address', 'phone', 'pic_name', 'pic_phone', 'npwp', 'created_time', 'updated_time', 'deleted_time'], 'safe'],
