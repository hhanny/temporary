    ...
    <div class="page-content error-page error2">
        <div class="container text-center">
            <div class="error-template">
                <h1 class="display-1 text-dark mb-2"><?= Html::encode($this->title) ?><span class="fs-20"></span></h1>
                <h5 class="error-details text-dark">
                    <?= nl2br(Html::encode($message)) ?>
                </h5>
                <div class="text-center">
                    <a class="btn btn-primary mt-5 mb-5" href="<?= Yii::$app->homeUrl?>"> <i class="fa fa-long-arrow-left"></i> Back
                        to Home </a>
                </div>
            </div>
        </div>
