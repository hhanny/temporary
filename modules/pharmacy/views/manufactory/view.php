...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Manufactories'), 'url' => ['index']];
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-options">
                ...
                <?= Html::a('<i class="fa fa-pencil"></i> ' . Yii::t('app', 'Update'), ['update', 'id' => $model->factory_id], ['class' => 'btn btn-primary btn-sm ms-2']) ?>
                <?= Html::a('<i class="fa fa-trash"></i> ' . Yii::t('app', 'Delete'), ['delete', 'id' => $model->factory_id], [
