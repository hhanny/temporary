    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-options">
                ...
                <?= Html::a('<i class="fa fa-pencil"></i> ' . Yii::t('app', 'Update'), ['update', 'id' => $model->unitgroup_id], ['class' => 'btn btn-primary btn-sm ms-2']) ?>
                <?= Html::a('<i class="fa fa-trash"></i> ' . Yii::t('app', 'Delete'), ['delete', 'id' => $model->unitgroup_id], [
        ...
        <div class="card-body pt-2">
            <?= DetailView::widget([
                ...
                'attributes' => [
                    ...
                    'created_time',
                    'updatedBy.employee.person_name',
                    'updated_time'
                ],
            ]) ?>
        </div>
