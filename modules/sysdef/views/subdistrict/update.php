...
$this->title = Yii::t('app', 'Update Subdistrict: {name}', [
        'name' => $model->subdistrict_id,
]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Subdistricts'), 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->subdistrict_id, 'url' => ['view', 'id' => $model->subdistrict_id]];
